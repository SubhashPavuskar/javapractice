...
public abstract class Otp implements java.io.Serializable{
  ...
  public String read(long interval) {
	    return leftPadding(hash(secret, interval));
	  }  
  /**
  ...
  private int bytesToInt(byte[] hash) {
    ...
    return binary % Digits.EIGHT.getValue();
  }
